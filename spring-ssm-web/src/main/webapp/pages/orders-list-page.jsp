                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
								<option <c:if test="${pageInfo.size==1}">selected</c:if>>1</option>
                                <option <c:if test="${pageInfo.size==2}">selected</c:if>>2</option>
                                <option <c:if test="${pageInfo.size==3}">selected</c:if>>5</option>
                                <option <c:if test="${pageInfo.size==4}">selected</c:if>>8</option>
                                <option <c:if test="${pageInfo.size==5}">selected</c:if>>10</option>
                            </select> 条
                        </div>
                    </div>
